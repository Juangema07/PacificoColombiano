...
cauca:['Cauca','El litoral caucano incluye municipios como Guapi, Timbiquí y López de Micay. Sus ríos, esteros, manglares, selvas y costa sostienen actividades como pesca, agricultura y turismo de naturaleza. En el departamento se encuentra el Parque Nacional Natural Gorgona, con ecosistemas terrestres y marinos.'],
narino:['Nariño','El Pacífico nariñense incluye Tumaco, Cabo Manglares y una extensa red de esteros y manglares. El Parque Nacional Natural Sanquianga protege una gran extensión de manglar y sus comunidades mantienen una relación histórica con la pesca y la recolección de piangua.'],
relieve:['Serranía del Baudó','El relieve del Pacífico combina llanuras costeras, valles fluviales, colinas y serranías. La serranía del Baudó acompaña buena parte del Pacífico norte y sus pendientes se encuentran muy cerca de ambientes de selva y mar. En Utría, por ejemplo, las elevaciones cubiertas de bosque llegan hasta la costa.'],
rios:['Ríos que conectan','El agua es una de las claves del territorio. Entre los ríos destacados se encuentran Atrato, San Juan, Baudó, Mira y Patía. Además de aportar agua y nutrientes, los ríos y esteros funcionan como corredores de movilidad y comunicación para muchas comunidades del litoral.'],
clima:['Un mundo húmedo','El Pacífico colombiano presenta precipitaciones muy abundantes y alta humedad. Estas condiciones favorecen bosques tropicales densos, redes de ríos y ecosistemas costeros productivos. La lluvia también influye en la movilidad, la agricultura, la pesca y la conservación del suelo.'],
selva:['Selva húmeda tropical','La selva húmeda tropical es uno de los grandes ecosistemas del Pacífico. Su estructura vegetal ofrece alimento, refugio y corredores para una enorme variedad de organismos. También ayuda a regular el agua y almacena carbono. En Utría y Gorgona la selva se encuentra estrechamente relacionada con el litoral y otros ecosistemas.'],
manglar:['Manglares','Los manglares ocupan zonas donde interactúan el agua marina, los esteros y el continente. Sus raíces sirven de refugio y crianza para peces, crustáceos y otros organismos. También protegen sectores de la costa y tienen una relación directa con actividades como la pesca y la recolección de piangua.'],
estuario:['Estuarios y esteros','En los estuarios se mezclan procesos de agua dulce y agua marina. Son ambientes dinámicos donde cambian salinidad, profundidad y circulación con las mareas. En el Pacífico forman redes de canales y esteros que conectan manglares, ríos, comunidades y zonas de pesca.'],
arrecife:['Arrecifes coralinos','Los arrecifes son ecosistemas marinos que ofrecen refugio y zonas de alimentación a numerosos organismos. En Gorgona y Utría existen formaciones coralinas asociadas a una alta diversidad marina. Su conservación depende de mantener la calidad del agua y reducir las presiones sobre la costa.'],
playa:['Playas y litoral','Las playas forman parte de la franja costera y cumplen funciones ecológicas además de ser espacios de uso comunitario y turístico. Algunas son utilizadas por tortugas marinas para la reproducción. Su dinámica cambia con mareas, oleaje, corrientes y aporte de sedimentos.'],
yubarta:['Yubarta o ballena jorobada','Las ballenas jorobadas llegan cada año a las aguas cálidas del Pacífico colombiano durante su migración. El Ministerio de Ambiente señala que la temporada suele concentrarse entre julio y noviembre. Las aguas costeras son importantes para reproducción y crianza, por lo que el tránsito responsable de embarcaciones es parte de la conservación.'],
tortugas:['Tortugas marinas','Las aguas y playas del Pacífico sirven como zonas de alimentación, refugio y reproducción para tortugas marinas. Utría, por ejemplo, protege playas donde llegan especies a desovar. La conservación requiere cuidar tanto la arena y vegetación costera como los ambientes marinos cercanos.'],
aves:['Aves del Pacífico','La combinación de selva, ríos, manglares, playas y litoral crea muchos hábitats para aves. Algunas especies son residentes y otras utilizan la costa durante sus desplazamientos. Los humedales y manglares son especialmente importantes como lugares de alimentación y refugio.'],
corales:['Arrecifes y fauna marina','Los arrecifes coralinos forman estructuras que sirven de refugio a peces, moluscos, crustáceos y otros organismos. En Gorgona se han documentado comunidades coralinas junto a una amplia diversidad marina. La protección de estos ambientes ayuda a conservar cadenas ecológicas completas.'],
territorio:['Comunidades y territorio','La geografía humana del Pacífico está marcada por la relación cotidiana con ríos, esteros, selva y litoral. En muchos lugares el transporte fluvial y marítimo es fundamental. La alimentación, los oficios, la vivienda, la música y las celebraciones también están vinculados con los recursos y paisajes locales.'],
oralidad:['Tradición oral','La tradición oral conserva historias, conocimientos, cantos, relatos y formas de interpretar el territorio. La transmisión entre generaciones permite mantener memoria colectiva y prácticas culturales. En el Pacífico, la palabra y la música tienen un papel importante en la vida comunitaria.'],
diversidad:['Diversidad cultural','El Pacífico colombiano tiene una fuerte presencia de comunidades afrocolombianas y pueblos indígenas, además de otras poblaciones locales. Sus conocimientos sobre navegación, pesca, plantas, cocina, música y manejo del territorio forman parte del patrimonio vivo de la región.'],
currulao:['Currulao','El currulao es una expresión musical emblemática del Pacífico Sur. Se relaciona con la marimba de chonta, los cununos, los bombos, los guasás y las voces. Además de música, es una práctica social que acompaña baile, encuentro y transmisión de conocimientos.'],
arrullo:['Arrullo','El arrullo integra canto y participación comunitaria y forma parte de las expresiones tradicionales del Pacífico Sur. Su práctica está vinculada a espacios de encuentro, memoria y transmisión cultural.'],
alabao:['Alabao','El alabao es una expresión vocal tradicional relacionada con la memoria y con prácticas comunitarias. Sus cantos pueden acompañar momentos colectivos y conservar conocimientos transmitidos entre generaciones.'],
juga:['Juga','La juga hace parte del repertorio de músicas y cantos tradicionales del Pacífico Sur. Sus interpretaciones combinan voces, instrumentos de percusión y marimba dentro de contextos festivos y comunitarios.'],
agricultura:['Agricultura','La agricultura es una actividad económica importante para numerosas comunidades. Los cultivos y huertas locales aportan alimentos y medios de vida, y se relacionan con las condiciones de lluvia, suelos, ríos y acceso al territorio.'],
pesca:['Pesca','La pesca artesanal y comercial está directamente vinculada con ríos, esteros y mar. Además del pescado, existen actividades de recolección de moluscos como la piangua en zonas de manglar. La conservación de los ecosistemas acuáticos es fundamental para mantener esta actividad.'],
'mineria-economia':['Minería','La minería forma parte de la historia económica de distintos territorios del Pacífico, especialmente alrededor de depósitos de oro. Su importancia económica debe analizarse junto con los impactos que pueden producir prácticas no controladas sobre ríos, suelos, bosques y comunidades.'],
puertos:['Actividad portuaria','Buenaventura es el principal referente portuario del litoral Pacífico colombiano. El movimiento de mercancías y servicios portuarios conecta el territorio con redes nacionales e internacionales. Esta actividad convive con comunidades pesqueras y con ecosistemas costeros que requieren manejo responsable.'],
turismo:['Turismo de naturaleza y cultura','El Pacífico ofrece selvas, manglares, playas, avistamiento de fauna, gastronomía y expresiones culturales. Utría, Gorgona, Uramba Bahía Málaga y otros lugares protegidos reciben actividades de turismo de naturaleza. La planificación debe priorizar conservación, seguridad y participación comunitaria.'],
forestal:['Recursos forestales','Los bosques aportan madera, frutos, fibras, plantas y otros recursos que pueden tener usos locales. El reto está en diferenciar el aprovechamiento responsable de la extracción que deteriora el bosque. La restauración y el manejo comunitario son herramientas importantes para conservar estos recursos.'],
utria:['Parque Nacional Natural Utría','Utría está en Chocó y protege selva húmeda tropical, manglares, playas, litorales rocosos, arrecifes y ambientes marinos. Parques Nacionales registra allí especies migratorias como tortugas, aves y ballenas. También destaca la relación del área con comunidades afrocolombianas e indígenas.'],
gorgona:['Parque Nacional Natural Gorgona','Gorgona pertenece al departamento del Cauca y reúne selva húmeda tropical, manglares, playas arenosas, litoral rocoso y arrecifes coralinos. Parques Nacionales registra una amplia diversidad terrestre y marina y señala la importancia de la participación de comunidades pesqueras en procesos de conservación.'],
